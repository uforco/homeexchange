        ...
        <div className=' flex h-12 overflow-hidden justify-between items-center w-full ' >
            ...
            <div className=' flex gap-5 '  >
              <NavLink to="/bookinglist" className={ ({isActive}) => isActive? "btn bg-gray-300 btn-ghost btn-circle" :  "btn btn-ghost btn-circle"}>
                ...
                {
                  User? 
                    <button onClick={LogOut} className='btn btn-ghost btn-circle text-3xl font-bold text-black p-2 ' ><BiPowerOff></BiPowerOff> </button>
                  :
                    <Link to="/login" className='btn btn-ghost btn-circle text-2xl font-bold text-black p-2 ' ><AiOutlineLogin></AiOutlineLogin></Link>
                }
            </div>
        </div>
  );
