          ...
          <ul className=" grid grid-cols-2 sm:grid-cols-3 gap-10 " >
                <li>
                    <div className=" flex justify-start items-center gap-2 " >
                        <span> 
                            <Lottie options={defaultOptions(wifiani)}
                            height={wh}
                            width={wh}/>
                        </span>
                ...
                <li>
                    <div className=" flex justify-start items-center gap-2 " >
                        <span> 
                            <Lottie options={defaultOptions(Tvani)}
                            height={wh}
                            width={wh}/>
                        </span>
                ...
                <li>
                    <div className=" flex justify-start items-center gap-2 " >
                        <span> 
                            <Lottie options={defaultOptions(Washingmachine)}
                            height={wh}
                            width={wh}/>
                        </span>
                ...
                <li>
                    <div className=" flex justify-start items-center gap-2 " >
                        <span> 
                            <Lottie options={defaultOptions(Microwaveoven)}
                            height={wh}
                            width={wh}/>
                        </span>
                ...
                <li>
                    <div className=" flex justify-start items-center gap-2 " >
                        <span > 
                            <Lottie options={defaultOptions(Freezer)}
                            height={wh}
                            width={wh}/>
                        </span>
                ...
                <li>
                    <div className=" flex justify-start items-center gap-3 " >
                        <span > 
                            <Lottie options={defaultOptions(AC)}
                            height={wh}
                            width={wh}/>
                        </span>
                ...
                <li>
                    <div className=" flex justify-start items-center gap-3 " >
                        <span > 
                            <Lottie options={defaultOptions(kitchen)}
                            height={wh}
                            width={wh}/>
                        </span>
