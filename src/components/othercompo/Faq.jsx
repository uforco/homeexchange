const Faq = () => {
  return (
    <div className=" mb-8 ">
      ...
      <div>
        <div>
          <div tabIndex={0} className="collapse rounded-sm border ">
            <div className="collapse-title text-xl font-medium">
              Is this accommodation suitable for remote workers?
            </div>
            <div className="collapse-content">
              <p>
                Yes, this accommodation has a wifi connection. We recommend that
                you discuss this with the host to ensure that the connection
                speed is sufficient for your needs.
              </p>
            </div>
          </div>
        </div>
