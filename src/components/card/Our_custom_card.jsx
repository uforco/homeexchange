  ...
  return (
    <div>
      <div>
        <Card
          href="#"
          className="max-w-sm md:h-[310px] shadow-lg shadow-slate-300 md:w-[290px] overflow-hidden hover:scale-105 transition-all  hover:bg-gradient-to-tl from-slate-400/10 via-slate-100 via-30% to-white to-90% hover:border-slate-50 "
        >
          <div>
          ...
          <div>
            <Avatar img={avatarImg} rounded>
              <div className="space-y-1 font-medium ">
                <div>{avatarName}</div>
                <div className="text-sm text-gray-500 ">{avatarLocation}</div>
              </div>
            </Avatar>
          </div>
        </Card>
