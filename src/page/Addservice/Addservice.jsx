...
const Addservice = () => {
  ...
  const addservicesystem = (e) => {
    ...
    const servicedel = {
      ...
      providerEmail,
      providerPhoto,
      UploadTime: serviceUploadtime,
    };

    axios.post("/addservice", servicedel).then((res) => {
  ...
  return (
    <div className=" relative w-full h-full ">
      <Helmattitle title={"Home Exchage | Dashboard - Addservice"}></Helmattitle>
            ...
            <section className=" p-6 mx-auto rounded-md ">
              ...
              <form onSubmit={addservicesystem}>
                ...
                <div className="flex justify-end mt-6">
                  <button
                    type="submit"
                    className=" z-10 px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-600 rounded-md hover:bg-gray-700 focus:outline-none  focus:bg-gray-700"
                  >
                    Save
                  </button>
                </div>
